...
namespace Northplay\NorthplayApi\Controllers\Integrations\Games\Pragmaticplay;
...
class PragmaticplayKernel
{
    ...
    public function __construct()
    {
        ...
        $this->api_url = env('APP_URL')."/northplay/gw/pragmaticplay/game_event/"; //+session_id
        $this->session_url = env('APP_URL')."/northplay/play/pragmaticplay/"; //+session_id
        $this->dogDebug = [];
    }
    ...
    public function create_session($session_id)
    {
        ...
        $url = 'https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs20stickywild&websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&jurisdiction=99&lobby_url=https%3A%2F%2Fwww.pragmaticplay.com%2Fen%2F&lang=EN&cur=USD';
        ...
        $game_session = $this->getQueryParameter($session_url, 'mgckey') ;
    ...
    public function show($session_id)
    {
        ...
        return view("northplay::gateway-pragmaticplay-game")->with("session_data", $data);
    }
